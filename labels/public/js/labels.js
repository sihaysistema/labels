  ...
  refresh: function (frm) {
    ...
    cur_frm.page.add_action_icon(__("fa fa-file-pdf-o"), function () {
        ...
        fields: [
          {
            ...
            description: __(
              "Seleccione el estilo de sticker que desee generar"
            ),
          },
          {
            fieldtype: "Button",
      ...
      dialog.fields_dict.btn_generar.$wrapper.on("click", function (e) {
        ...
        if (
          dialog.fields_dict.sticker_type.value ==
          "Sticker con fecha de cosecha"
        ) {
          estilo_sticker = "1";
        }
        ...
        if (
          dialog.fields_dict.sticker_type.value == "Sticker con todos los datos"
        ) {
          estilo_sticker = "3";
        }
    ...
    cur_frm.page.add_action_icon(__("fa fa-file-pdf-o"), function () {
      ...
      dialog.fields_dict.btn_generar.$wrapper.on("click", function (e) {
        ...
        if (
          ...
          cb = "labels.api_labels.delivery_note_labels";
        }
        ...
        if (
          ...
          sticker_style = "outgoing_serial_no_flyer";
          cb = "labels.api_labels.delivery_note_labels_fliers";
        }
        /*
                if (dialog.fields_dict.sticker_type.value == 'Sticker con fecha de vencimiento') {
                    estilo_sticker = '2';
        ...
        frappe.call({
          ...
          args: {
            ...
            dict_data: cur_frm.doc.items,
            label_format: sticker_style,
            receipt_date: cur_frm.doc.posting_date,
          },
          callback: function (r) {
            // We show an alert that the stickers have been generated
            frappe.show_alert({
